...
# 8x RTX 3090 fine-tuning script for VideoMAE (base checkpoint)
OUTPUT_DIR="${OUTPUT_ROOT}/videomae_base_ft"
DATA_PATH="${DATA_ROOT}"
EVAL_DATA_PATH="${DATA_ROOT}"
MODEL_PATH="${CKPT_ROOT}/videomae_b.pth"  # released model-zoo name; the run used checkpoint.pth
...
LOG_FILE="${LOG_DIR}/videomae_base_finetune_8gpu_$(date +%Y%m%d_%H%M%S).log"
