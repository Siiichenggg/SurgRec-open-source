...
# 8x RTX 3090 resume fine-tuning script for VideoMAE (e149 checkpoint)
OUTPUT_DIR="${OUTPUT_ROOT}/videomae_e149_ft"
DATA_PATH="${DATA_ROOT}"
EVAL_DATA_PATH="${DATA_ROOT}"
MODEL_PATH="${CKPT_ROOT}/surgrec_mae.pth"  # released name; the run used videomae_e149.pth
RESUME_PATH="${OUTPUT_ROOT}/videomae_e149_ft/checkpoint-29.pth"
...
LOG_FILE="${LOG_DIR}/videomae_e149_resume_8gpu_$(date +%Y%m%d_%H%M%S).log"
