...
class PatchEmbed(nn.Module):
    """ Image to Patch Embedding for Endo-FM
    Modified to support Endo-FM's video processing pipeline
    """
...
class EndoFMVisionTransformer(nn.Module):
    """ Endo-FM Vision Transformer 
    This is the main architecture for Endo-FM, based on Video Transformer
    """
    def __init__(self, 
                 img_size=224, 
                 patch_size=16, 
    ...
    def forward_features(self, x):
        ...
        # Global average pooling or use first token
...
VisionTransformer = EndoFMVisionTransformer
